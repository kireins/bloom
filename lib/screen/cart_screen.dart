...
class _CartScreenState extends State<CartScreen> {
        ...
        child: cartList.length > 0
          ...
          child: ListView.builder(
            itemBuilder: (context, index) {
              var plant = findPlant(cartList[index]);
              return Card(
                elevation: 0,
                    ...
                    Expanded(
                      child: ClipRRect(
                        ...
                        child: Container(
                          ...
                          decoration:
                          BoxDecoration(color: plant.plantColor),
                        ),
                      ),
                    ),
                    Expanded(
  ...
  Plant findPlant(Cart cartItem) {
    return plantList.firstWhere((plant) => plant.plantId == cartItem.plantId);
  }

  deleteItemCart(int plantId) {
    setState(() {
      cartList.removeWhere((cartItem) => cartItem.plantId == plantId);
      if (cartList.length == 0) {}
    });
  }
}
